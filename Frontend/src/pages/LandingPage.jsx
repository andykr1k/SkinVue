export default function LandingPage() {
  return (
    <div className="bg-ghostwhite dark:bg-richblack p-5 dark:text-ghostwhite text-richblack ">
        ...
        <div class="px-4 py-4 sm:px-6 sm:py-8 lg:px-8 ">
          ...
          <div className="flex justify-center">
            <div class="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
              <h2 class="text-2xl font-bold sm:text-3xl dark:text-ghostwhite text-richblack">
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3">
              <div class="block rounded-xl p-4 shadow-sm focus:outline-none focus:ring bg-black/10 dark:text-ghostwhite text-richblack">
                ...
                <h2 class="mt-2 font-bold">Scan</h2>
              ...
              <div class="block rounded-xl p-4 shadow-sm focus:outline-none focus:ring bg-black/10 dark:text-ghostwhite text-richblack">
                ...
                <h2 class="mt-2 font-bold">Analyze</h2>
              ...
              <div class="block rounded-xl p-4 shadow-sm focus:outline-none focus:ring bg-black/10 dark:text-ghostwhite text-richblack">
                ...
                <h2 class="mt-2 font-bold">Track</h2>
              ...
              <div class="block rounded-xl p-4 shadow-sm focus:outline-none focus:ring bg-black/10 dark:text-ghostwhite text-richblack">
                ...
                <h2 class="mt-2 font-bold">History</h2>
      ...
      <footer class="bg-ghostwhite dark:bg-richblack dark:text-ghostwhite text-richblack">
